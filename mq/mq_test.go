...
func TestMqtt(t *testing.T) {
	c, err := New(&Options{Address: "127.0.0.1:35003", Goc: 5}, NewMqtt)
	if err != nil {
		c.Release()
		log.Fatalln(err)
	}
...
func TestStomp(t *testing.T) {
	c, err := New(&Options{Address: "127.0.0.1:35002", Goc: 1}, NewStomp)
	if err != nil {
		c.Release()
		log.Fatalln(err)
	}
...
func TestNats(t *testing.T) {
	c, err := New(&Options{Address: NatsURL, Goc: 1}, NewNats)
	if err != nil {
		c.Release()
		log.Fatalln(err)
	}
